...
namespace Task_Try_Out_Forum.Controllers
{
    public class ModeratorController : Controller
    {
        ...
        public ModeratorController(ILogger<ModeratorController> logger, AppDBContext appDbContext, IConfiguration configuration)
        {
            _logger = logger;
        ...
        {
            var member = from i in _AppDbContext.users where i.Role=="Member" select i;
        ...
        public IActionResult BanMember(int id)
        {
            ...
            member.Ban = true;
            _AppDbContext.SaveChanges();
            return RedirectToAction("ListUser","Moderator");
        }
